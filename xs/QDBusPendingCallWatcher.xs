...
MODULE = Qt::DBus			PACKAGE = Qt::DBus::PendingCallWatcher
PROTOTYPES: DISABLE
...
PPCODE:
    ...
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::DBus::PendingCallWatcher", (void *)ret);
    XSRETURN(1);
        break;
      }
    case 3:
      {
        ...
        Perl_croak(aTHX_ "arg10 is not of type Qt::DBus::PendingCall");
