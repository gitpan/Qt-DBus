package Qt::DBus::QDBusServer;
# THE FOLLOWING CODE IS AUTOMATED, ANY MODIFICATION WILL BE LOST!
# classname: QDBusServer
# file     : QtDBus/qdbusserver.h
...
=item   QDBusServer(const QString & address, QObject * parent)

=item   QDBusServer(const QString & address, QObject * parent = 0)
